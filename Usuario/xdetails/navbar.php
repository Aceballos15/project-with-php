...
<a href="https://api.whatsapp.com/send?phone=+573007308535&text=Hola, desearia obtener información sobre ustedes" class="float" target="_blank">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <nav class="header__menu mobile-menu">
                        <ul>
                            ...
                            <li  class=""><a href="../shop.php">Tienda</a></li>
                            <li><a href="#">Blog</a>
                                <ul class="dropdown">
                ...
                <div class="col-lg-3 col-md-3">
                    <div class="header__nav__option">
                        <a href="shopping-cart.php"><img src="../src/img/icon/cart.png" alt=""> <span>0</span></a>
