...
<div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card">
                <h5 class="card-header">Envios pendientes</h5>
                <h5 class="card-header"><a href="env_list.php">* Ver envios realizados</a></h5>
                  <table class="table">
                    <thead>
                      <tr>
                        <th>Cliente</th>
                    ...
                    <tbody class="table-border-bottom-0">
                      ...
                      <?php echo $cedula; ?>
                        ...
                        <td><span class="badge bg-label-primary me-1">Pendiente</span></td>
                        <td>
                        $8000
                        </td>
                        <td>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="ver_prod.php?carrito=<?php echo $result['carritos_idcarritos'] ?>&env=<?php echo $result['idEnvios'];?>&est=<?php echo $result['estado']; ?>"
                                ><i class="bx bx-edit-alt me-1"></i> Ver productos</a
                              >
                              <a class="dropdown-item" href="App/confirm_env.php?env=<?php echo $result['idEnvios']; ?>&est=<?php echo $result['estado']; ?>"
                                ><i class="bx bxs-send"></i>Confirmar envio</a
                              >
                            </div>
                          </div>
                        </td>
...
<nav aria-label="Page navigation example">
  <ul class="pagination justify-content-end">
    <li class="page-item">
      <a href="envios.php?pag=<?php echo $_GET['pag']-1; ?>"class="page-link">Anterior</a>
    </li>
    <?php for($i=1; $i <= $paginas ; $i++): ?>
    <li class="page-item"><a class="page-link" href="envios.php?pag=<?php echo $i; ?>"><?php echo $i; ?></a></li>
    <?php endfor ?>
    <li class="page-item">
      <a class="page-link" href="envios.php?pag=<?php echo $_GET['pag']+1;  ?>">Siguiente</a>
    </li>
  </ul>
</nav> 
