...
<div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Administrador/</span> Vendedores</h4>
                ...
                <h5 class="">Informacion de los vendedores inactivos</h5>
                  ...
                  <table class="table">
                    ...
                    <?php foreach($resultado as $result): ?>
                      <tr>
                        ...
                        <a class="btn btn-success" href="users/cambiar_estado.php?est_vend=<?php echo $result['estado'];?>
...
<nav aria-label="Page navigation example">
  <ul class="pagination justify-content-end">
    <li class="page-item">
      <a href="vend_inactivos.php?pag=<?php echo $_GET['pag']-1; ?>"class="page-link">Anterior</a>
    </li>
    <?php for($i=1; $i <= $paginas ; $i++): ?>
    <li class="page-item"><a class="page-link" href="vend_inactivos.php?pag=<?php echo $i; ?>"><?php echo $i; ?></a></li>
    <?php endfor ?>
    <li class="page-item">
      <a class="page-link" href="vend_inactivos.php?pag=<?php echo $_GET['pag']+1;  ?>">Siguiente</a>
    </li>
  </ul>
</nav> 
<?php
